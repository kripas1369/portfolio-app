...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Kripas Khatiwada
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        I am a learner who believes that human nature and our capacity for resiliency is fascinating component of life.
         I am always ambitious to learn, grow and excel in a creative work environment.
        </p>
